    ...
    <div style={{ width: '100%', height: '100%', overflow: 'hidden', position: 'relative' }} onKeyDown={onKeyDown} onDrop={onDrop} onDragOver={onDragOver} tabIndex={0}>
      ...
      >
        ...
        <Panel position="bottom-center">
          <div style={{ display: 'flex', alignItems: 'center', background: 'var(--bg-elevated)', backdropFilter: 'blur(20px)', borderRadius: '99px', boxShadow: '0 8px 32px rgba(0,0,0,0.35)', border: '1px solid var(--border-default)', overflow: 'hidden', marginBottom: '1rem' }}>
            {!editMode ? (
              <>
