  ...
  generateOfferLetter: async (data, isPreview = false) => {
    ...
    if (isFT) {
      ...
      const collabPayText = data.isPaid
        ? `As compensation for your services, you will receive a collaboration fee of ${data.stipend} ${data.currency}, payable on a ${data.paymentFrequency} basis, as mutually agreed.`
      ...
      renderJustifiedParagraph([
        { text: `We look forward to a productive and mutually beneficial partnership with you.` }
      ]);
